...
public class EmployeeImpl {
    ...
    public void add(Employee emp) throws InvalidOperationException 
    {
        if (employeeArray[emp.getId()] != null){
            throw new InvalidOperationException("Error adding employee, employee id already exist " +emp.getId()); 
            } 
            try{
    ...
    public Employee findById(int id) throws InvalidOperationException {
        try {
         return employeeArray[id];
             ...
             throw new InvalidOperationException ("Error finding emploee ", e); 
                    }
